...
class SystemChangeLogView extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormWrapper( new TQuickForm('form_table_logger') );
        ...
        $this->form->addQuickField( new TLabel(_t('Table')), $tablename);
        $this->form->addQuickField( new TLabel('Login'), $login);
        $tablename->placeholder = _t('Table');
        ...
        $container->add(TPanelGroup::pack(_t('Change Log'), $this->form));

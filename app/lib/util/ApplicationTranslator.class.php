...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'The field ^1 is not a valid date';
        ...
        $this->messages['en'][] = 'States';
        $this->messages['en'][] = 'State';
        $this->messages['en'][] = 'Countries';
        $this->messages['en'][] = 'Country';
        $this->messages['en'][] = 'Neighborhood';
        $this->messages['en'][] = 'Address';
        $this->messages['en'][] = 'Phone';
        $this->messages['en'][] = 'Site';
        $this->messages['en'][] = 'Responsible Name';
        $this->messages['en'][] = 'Responsible CPF';
        $this->messages['en'][] = 'Logo';
        $this->messages['en'][] = 'Bank';
        $this->messages['en'][] = 'Description';
        $this->messages['en'][] = 'Localization';
        $this->messages['en'][] = 'Language';
        $this->messages['en'][] = 'Appointment Book';
        $this->messages['en'][] = 'Appointment';
        $this->messages['en'][] = 'Peopple';
        $this->messages['en'][] = 'Person';
        $this->messages['en'][] = 'Terapy';
        $this->messages['en'][] = 'Terapies';
        $this->messages['en'][] = 'Color';
        $this->messages['en'][] = 'Birth Date';
        $this->messages['en'][] = 'Cel Phone';
        $this->messages['en'][] = 'Register Date';
        $this->messages['en'][] = 'Civil Status';
        $this->messages['en'][] = 'Observation';
        $this->messages['en'][] = 'Weekday';
        $this->messages['en'][] = 'Weekdays';
        ...
        $this->messages['en'][] = 'Assignmenter';
        $this->messages['en'][] = 'Courses';
        $this->messages['en'][] = 'Course';
        $this->messages['en'][] = 'Showedup';
        $this->messages['en'][] = 'Servicetab (Front)';
        $this->messages['en'][] = 'Servicetab (Back)';
        $this->messages['en'][] = 'Vacancies';
        $this->messages['en'][] = 'Schedulings';
        $this->messages['en'][] = 'Scheduling';
        $this->messages['en'][] = 'Report';
        $this->messages['en'][] = 'Start Date';
        $this->messages['en'][] = 'End Date';
        $this->messages['en'][] = 'Output Type';
        ...
        $this->messages['pt'][] = 'O campo ^1 contém uma data inválida';
        ...
        $this->messages['pt'][] = 'Cep';
        $this->messages['pt'][] = 'Municípios';
        $this->messages['pt'][] = 'Município';
        $this->messages['pt'][] = 'Estados';
        $this->messages['pt'][] = 'Estado';
        $this->messages['pt'][] = 'Países';
        $this->messages['pt'][] = 'País';
        $this->messages['pt'][] = 'Bairro';
        $this->messages['pt'][] = 'Endereço';
        $this->messages['pt'][] = 'Telefone';
        $this->messages['pt'][] = 'Site';
        $this->messages['pt'][] = 'Nome do Responsável';
        $this->messages['pt'][] = 'CPF do Responsável';
        $this->messages['pt'][] = 'Logotipo';
        $this->messages['pt'][] = 'Banco';
        $this->messages['pt'][] = 'Descrição';
        $this->messages['pt'][] = 'Localização';
        $this->messages['pt'][] = 'Língua';
        ...
        $this->messages['pt'][] = 'Tarefeiro';
        $this->messages['pt'][] = 'Cursos';
        $this->messages['pt'][] = 'Curso';
        $this->messages['pt'][] = 'Compareceu';
        $this->messages['pt'][] = 'Ficha de Atendimento (Frente)';
        $this->messages['pt'][] = 'Ficha de Atendimento (Verso)';
        ...
        $this->messages['pt'][] = 'Tipo de Saída';

...
class SystemUserList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickField(_t('Login'), $login, '100%' );
        $this->form->addQuickField(_t('Email'), $email, '100%' );
        $this->form->addQuickField(_t('Active'), $active, 50 );
        ...
        $this->form->addQuickAction(_t('New'),  new TAction(array('SystemUserForm', 'onEdit')), 'bs:plus-sign green');
        ...
        $container->add(TPanelGroup::pack(_t('Users'), $this->form));

...
class TTableWriterHTML implements ITableWriter
{
    ...
    public function addStyle($stylename, $fontface, $fontsize, $fontstyle, $fontcolor, $fillcolor, $border = 1)
    {
        ...
        $style->border_top       = "{$border}px solid #000000";
        $style->border_bottom    = "{$border}px solid #000000";
        $style->border_left      = "{$border}px solid #000000";
        $style->border_right     = "{$border}px solid #000000";
